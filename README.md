...
I build practical tools and data pipelines that turn raw information into actionable insights. My focus is on making data work for people — whether that's optimising staff schedules, monitoring infrastructure reliability, or automating the tedious stuff so teams can focus on what matters.

## What I Do

- **Data Analysis & Decision Support** — Designing analysis workflows that surface the metrics and patterns stakeholders actually need
